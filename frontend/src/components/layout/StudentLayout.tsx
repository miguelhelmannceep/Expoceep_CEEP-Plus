  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-start antialiased">
      ...
      <div className="w-full max-w-md min-h-screen bg-slate-50 flex flex-col relative shadow-2xl border-x border-slate-200/80">
        ...
        <header className="sticky top-0 z-30 bg-slate-900 text-white px-4 py-3 shadow-sm flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-400 flex items-center justify-center font-black text-slate-950 text-sm shadow-md">
              C+
            </div>
            <div>
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center flex-1 py-1.5 min-h-[48px] rounded-xl transition-all duration-150 ${
                    isActive
                      ? "text-emerald-600 font-bold scale-[1.03]"
